...
fig, (ax1, ax2, ax3) = plt.subplots(nrows=1, ncols=3, figsize=(5,7), constrained_layout=True)

ax1.plot(x_50, y_50, marker='0')
ax1.set_xlabel('Temperatura (K)')
ax1.set_ylabel('Volumen (nm)')
ax1.set_title('Simulación 2')

ax2.plot(x_150, y_150, marker='0')
ax2.set_xlabel('Temperatura (K)')
ax2.set_ylabel('Volumen (nm)')
ax2.set_title('Simulación 3')

ax3.plot(x_250, y_250, marker='0')
